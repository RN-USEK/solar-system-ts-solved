...
function isPlanet(data) {
    return typeof data === 'object' &&
        ...
        data.moons.every(function (moon) { return typeof moon === 'string'; });
}
function isAsteroid(data) {
    return typeof data === 'object' &&
        typeof data.name === 'string' &&
        typeof data.discoveryYear === 'number' &&
        typeof data.orbitalPeriod === 'number';
}
function isAllData(data) {
